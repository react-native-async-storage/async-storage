// ReactTestApp.cpp : Defines the entry point for the application.
//

#include "pch.h"
#include "ReactTestApp.h"
...
// Global Variables:
constexpr PCWSTR windowTitle = L"ReactTestApp";
constexpr PCWSTR mainComponentName = L"ReactTestApp";

...
type AsyncStorageHook =  {
  getItem: (callback?: ?(error: ?Error, result: string | null) => void): Promise<string | null>,
  setItem: (value: string, callback?: ?(error: ?Error) => void): Promise<null>,
  mergeItem: (value: string, callback?: ?(error: ?Error) => void): Promise<null>,
  removeItem: (callback?: ?(error: ?Error) => void): Promise<null>
}

function useAsyncStorage(key: string): AsyncStorageHook {
  return {
